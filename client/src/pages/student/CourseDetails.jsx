  ...
  return (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        {/* Right Column */}
        <div className="max-w-[500px] z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[250px] sm:min-w-[300px]">
          {playerData ? (
            <YouTube
            ...
            <img
              src={courseData.courseThumbnail || assets.defaultThumbnail}
          ...
          <div className="p-4">
            ...
            <div className="flex items-center text-sm gap-4 pt-2 text-gray-500">
            ...
            <button
              ...
              className="mt-4 w-full py-2 rounded bg-blue-600 text-white font-medium"
            >
