...
const TestimonialsSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
     ...
     <p className='md:text-base text-gray-500 mt-3'>Discover what makes EduTrack the top-choice LMS directly from organizations that use it around the globe.</p>
